...
We could modify the model to include another term $m_t$ that 
...
observe the this for several months and
...
We would see that each pollster has a different distribution in the
difference between Obama and Romney. We could modify the model 
...
For this lecture we will focus on the [Senate race in Florida](https://www.realclearpolitics.com/epolls/2018/senate/fl/florida_senate_scott_vs_nelson-6246.html)
