...
share an underlying philosophy and common Application Programming
Interface (APIs)_.
...
The common philosphy is called _"tidy"_ data. 
In _tidy_ data:
...
Working with tidy data is useful because 

* it creates a structured way of organizing data 
values within a data set. 
* it makes the data analysis process more efficient 
and simplifies the development of data analysis 
tools that work together. Will learn 
more about this later. 
* you can focus on the problem you are 
investigating, rather than the uninteresting 
logistics of data 
